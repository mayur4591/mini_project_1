...
class boxes extends StatefulWidget {
  ...
  State<boxes> createState() => _boxesState(name: name,price: price,image: image,ratings: ratings,index: index);
}

class _boxesState extends State<boxes> {

  _boxesState({required this.name,required this.price,required this.image,required this.ratings,required this.index});
  final String name;
  final String price;
  final int ratings;
  final String image;
