              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration:  InputDecoration(
                      prefixIcon: Icon(Icons.vpn_key_outlined,color: Colors.white.withOpacity(0.6),),
                      filled: true,
                      fillColor: Colors.white.withOpacity(0.1),
                      hintText: 'Password',
                      hintStyle: const TextStyle(color: Colors.white),
                ...
                Row(
                  ...
                  children: <Widget>[
                     Text('Does not have account?',style: TextStyle(color: Colors.white.withOpacity(0.8)),),
                    TextButton(
