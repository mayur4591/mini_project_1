              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration:  InputDecoration(
                      prefixIcon: Icon(Icons.person,color: Colors.white.withOpacity(0.6),size: 20,),
                      filled: true,
                      ...
                      enabledBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(width: 1, color: Colors.white.withOpacity(0.6)), //<-- SEE HERE
                      ),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration:  InputDecoration(
                      prefixIcon: Icon(Icons.vpn_key_outlined,color: Colors.white.withOpacity(0.6),size: 20,),
                      filled: true,
                      fillColor: Colors.white.withOpacity(0.1),
                      hintText: 'Password',
                      hintStyle: const TextStyle(color: Colors.white),
                ...
                Center(child: Text('Or',style: TextStyle(color: Colors.white.withOpacity(0.8),fontSize: 20),)),
                const SizedBox(height: 10,),
                const Padding(
                  padding: EdgeInsets.only(left: 28.0,right: 28,top: 10),
                  child: Divider(height: 4,color: Colors.white,thickness: 1,),
                ),
                Padding(
                      ...
                      child: TextButton(
                        ...
                        child: Row(
                          ...
                          children:  [
                            ...
                            const Text('Sign In',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),)
